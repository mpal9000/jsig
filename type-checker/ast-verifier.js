...
function _tryResolveInternalFunction(node, defn) {
    if (defn.type === 'typeLiteral' && defn.builtin &&
        ...
        return callFuncType;
        // console.log('_tryResolveInternalFunction', {
        //     node: this.meta.serializeAST(node),
        //     defn: this.meta.serializeType(defn),
        //     fnToCall: this.meta.serializeType(fnToCall),
        //     callFuncType: this.meta.serializeType(callFuncType)
        // });
    }
